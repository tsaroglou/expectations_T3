...
class Player(BasePlayer):
    ...
    comprehension_q4 = models.StringField(
        choices=[
            "I receive 6 points and my paired participant also receives 6 points.",
            "I receive 4 points and my paired participant receives 7 points.",
            "I receive 7 points and my paired participant receives 4 points."
        ],
        widget=widgets.RadioSelect,
    ...
    comprehension_q5 = models.StringField(
        choices=[
            ...
            "I receive 4 points and my paired participant receives 7 points.",
            "I receive 6 points and my paired participant receives 6 point."
        ],
        widget=widgets.RadioSelect,
    ...
    comprehension_q10 = models.StringField(
        ...
        widget=widgets.RadioSelect,
        label="6. If you choose Option B and your paired participant chooses Option A, what are the points?"
    )
#
...
class ComprehensionCheck(Page):
    ...
    def before_next_page(self, timeout_happened):
        correct_answers = {
            ...
            'comprehension_q4': 'I receive 4 points and my paired participant receives 7 points.',
            'comprehension_q5': 'I receive 5 points and my paired participant receives 5 points.',
        }
        wrong = []
    ...
    def vars_for_template(self):
        ...
        feedback_map = {
            'comprehension_q3': {
                ...
                'explanation': "The A–A cell yields you 6 and them also 6."
            },
            'comprehension_q4': {
                'label': "2. If you choose Option A and your paired participant chooses Option B, what are the points?",
                'correct': "I receive 4 points and my paired participant receives 7 points.",
                'explanation': "The A–B cell yields you 4 and them 7."
            },
            'comprehension_q5': {
                'label': "3. If you choose Option B and your paired participant chooses Option B, what are the points?",
                'correct': "I receive 5 points and my paired participant receives 5 points.",
                'explanation': "The B-B cell yields you 5 and them also 5."
            },
        }
        questions = []
...
class ComprehensionCheck2(Page):
    ...
    def before_next_page(self, timeout_happened):
        correct_answers = {
            'comprehension_q8': 'I receive 4 points and my paired participant receives 7 points.',
            'comprehension_q9': 'I receive 5 points and my paired participant also receives 5 points.',
            'comprehension_q10': 'I receive 7 points and my paired participant receives 4 points.',
        }
        wrong = []
        for field, correct in correct_answers.items():
            if getattr(self, field) != correct:
